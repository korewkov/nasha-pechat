...
const faqs = [
  ...
  ["Как передать фото?", "Фото можно передать через Telegram, MAX, ВКонтакте или отправить на электронную почту. После заявки мы подскажем самый удобный способ и поможем с файлами."],
