...
```txt
Дата и время | Имя | Телефон | Telegram / WhatsApp | Тип услуги | Формат | Количество | Бумага | Дополнительные услуги | Есть ли макет | Срочность | Предварительная стоимость | Комментарий | Источник заявки | Статус
```
